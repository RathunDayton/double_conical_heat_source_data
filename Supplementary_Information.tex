...
Grid-independence and numerical-resolution data used to assess the sensitivity
of the predicted melt-pool dimensions to computational grid spacing. The file
contains the grid cases and the corresponding simulation results used to
justify the mesh resolution adopted in the manuscript.
