...
\textbf{Online Resource 23 (ESM\_23.xlsx).}\\
Spreadsheet summarizing the principal process parameters and heat-source
model parameters used in the numerical simulations presented in the
manuscript. The file includes the NIST AM-Bench 2022 and AM-Bench 2025
single-track and multi-track cases, including the 5 ms and 0.75 ms
turnaround-time cases. For each simulation, the spreadsheet identifies
the heat-source model, track configuration, laser turnaround time, laser
power, scan speed, hatch spacing, laser spot size, Double Conical Heat
Source (DCHS) geometric and power-distribution parameters, and the heat
transfer coefficients used in the model. This resource provides a
consolidated reference for the simulation conditions and model parameters
used throughout the study.

\section*{S4. Supporting graphs}

\textbf{Online Resource 24 (ESM\_24.png).}\\
...
Spreadsheet (XLSX) &
AM-Bench 2022/2025 &
Summary of process conditions, heat-source parameters, and heat-transfer
parameters used for all simulation cases. \\
...
The supplementary materials accompanying this article provide the numerical
data, simulation videos, temperature histories, model parameters, and other
supporting information used in the analyses presented in the manuscript as Online Resources 1--24.

The complete ANSYS Fluent simulation files used in this study, including the
case and associated simulation files, are publicly available at:
\newline
\url{https://drive.google.com/file/d/1emnQsmab7iHTuRSzj2tedGJ9wzvV-wEV/view?usp=sharing}

 Further data and simulation files related to this study are available
